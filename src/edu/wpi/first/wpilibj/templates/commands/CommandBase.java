...
public abstract class CommandBase extends Command {
    ...
    public static final PID drivePIDRight = new PID(RobotMap.AUTONOMOUS_DRIVE_DESTINATION, RobotMap.DRIVER_KP, RobotMap.DRIVER_KI, RobotMap.DRIVER_KD, RobotMap.DRIVER_DT, driveTrain.getRightInput(), driveTrain.getRightOutput());
